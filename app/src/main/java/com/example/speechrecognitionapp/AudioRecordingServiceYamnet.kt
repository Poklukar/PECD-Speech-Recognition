...
class AudioRecordingServiceYamnet: Service(), AudioRecordingServiceInterface {

    companion object {
        private val TAG = AudioRecordingServiceYamnet::class.simpleName
    ...
    inner class RunServiceBinder : Binder() {
        val service: AudioRecordingServiceYamnet
            get() = this@AudioRecordingServiceYamnet
    }
