...
class AudioRecordingServiceSilero : Service(), AudioRecordingServiceInterface {

    companion object {
        private val TAG = AudioRecordingServiceSilero::class.simpleName
    ...
    inner class RunServiceBinder : Binder() {
        val service: AudioRecordingServiceSilero
            get() = this@AudioRecordingServiceSilero
    }
    ...
    private fun record() {
        ...
        while (isRecording) {
            ...
            if (dB > -45) {
                ...
                val chunk = shortBuffer.take(FrameSize.FRAME_SIZE_512.value).toShortArray()
